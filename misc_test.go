...
func TestHumanize(t *testing.T) {
	tests := []struct {
		...
		{1023, "1023 B"},
		{1024, "1.00 KiB"},
		{1025, "1.00 KiB"},                // 1.000976563 KiB
		{10188, "9.95 KiB"},               // 9.94921875 KiB
		{10189, "9.95 KiB"},               // 9.950195313 KiB
		{10240, "10.00 KiB"},              // 10 KiB
		{10291, "10.05 KiB"},              // 10.049804688 KiB
		{10292, "10.05 KiB"},              // 10.05078125 KiB
		{10342, "10.10 KiB"},              // 10.099609375 KiB
		{102348, "99.95 KiB"},             // 99.94921875 KiB
		{102349, "99.95 KiB"},             // 99.950195313 KiB
		{1023487, "999.50 KiB"},           // 999.499023438 KiB
		{1023488, "999.50 KiB"},           // 999.5 KiB
		{1048063, "1023.50 KiB"},          // 1023.499023438 KiB
		{1048064, "1023.50 KiB"},          // 1023.5 KiB
		{1072693248, "1023.00 MiB"},       // 1023 MiB
		{1073217535, "1023.50 MiB"},       // 1023.499999046 MiB
		{1073217536, "1023.50 MiB"},       // 1023.5 MiB
		{1073741824, "1.00 GiB"},          // 1 GiB
		{1610612736, "1.50 GiB"},          // 1.5 GiB
		{1319413953332, "1.20 TiB"},       // 1.2 TiB
		{1463669878895412, "1.30 PiB"},    // 1.3 PiB
		{7955158381787244544, "6.90 EiB"}, // 6.9 EiB
		{math.MaxInt64, "8.00 EiB"},       // 8 EiB
	}
	...
	tests = []struct {
		...
		{999, "999 B"},
		{1000, "1.00 kB"},          // 1.0 kB
		{1001, "1.00 kB"},          // 1.001 kB
		{1049, "1.05 kB"},          // 1.049 kB
		{1050, "1.05 kB"},          // 1.05 kB
		{1051, "1.05 kB"},          // 1.051 kB
		{9949, "9.95 kB"},          // 9.949 kB
		{9950, "9.95 kB"},          // 9.95 kB
		{9951, "9.95 kB"},          // 9.951 kB
		{9999, "10.00 kB"},         // 9.999 kB
		{10000, "10.00 kB"},        // 10.0 kB
		{10001, "10.00 kB"},        // 10.001 kB
		{99949, "99.95 kB"},        // 99.949 kB
		{99950, "99.95 kB"},        // 99.95 kB
		{99951, "99.95 kB"},        // 99.951 kB
		{999499, "999.50 kB"},      // 999.499 kB
		{999500, "999.50 kB"},      // 999.5 kB
		{999501, "999.50 kB"},      // 999.501 kB
		{999999, "1.00 MB"},        // 999.999 kB
		{1000000, "1.00 MB"},       // 1.0 MB
		{1000001, "1.00 MB"},       // 1.000001 MB
		{999499999, "999.50 MB"},   // 999.499999 MB
		{999500000, "999.50 MB"},   // 999.5 MB
		{999500001, "999.50 MB"},   // 999.500001 MB
		{999999999, "1.00 GB"},     // 999.999999 MB
		{1000000000, "1.00 GB"},    // 1.0 GB
		{1000000001, "1.00 GB"},    // 1.000000001 GB
		{math.MaxInt64, "9.22 EB"}, // 9.223372036854776 EB
	}
